  ...
  const services = [
    ...
    },
    {
      ...
      prices: [
        ...
        { service: "Аллергологическое обследование", price: "250 000 сум" },
  ...
  <div className="container mx-auto max-w-6xl flex items-center justify-between">
    ...
    <Sheet>
      ...
      <main className="flex-1">
        ...
        <section id="services" className="w-full py-16 md:py-24 lg:py-32 bg-[#F7F8FA]">
          <div className="container px-4 md:px-6 mx-auto max-w-6xl">
        ...
        <section id="about-clinic" className="w-full py-16 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 mx-auto max-w-6xl">
            <div className="flex flex-col lg:flex-row items-center">
        ...
        <section id="reviews" className="w-full py-16 md:py-24 lg:py-32 bg-[#F7F8FA]">
          <div className="container px-4 md:px-6 mx-auto max-w-6xl">
        ...
        <section id="doctors" className="w-full py-16 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6 mx-auto max-w-6xl">
        ...
        <section className="w-full py-16 md:py-24 lg:py-32 bg-[#0066FF]" >
          <div className="container px-4 md:px-6 mx-auto max-w-6xl">
